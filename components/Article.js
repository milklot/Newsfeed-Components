...
const result = document.querySelector('.articles');

data.forEach(item => {
    result.appendChild(articleMaker(item));
});
...
const myObject = {
    ...
    date: 'Aug 1st, 2007',
    firstParagraph: `Have you ever ever`,
    secondParagraph: `I wish you best`,
    thirdParagraph: `keep calm and drink whatever you like`
};

result.appendChild(articleMaker(myObject));